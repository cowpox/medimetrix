...
CREATE TABLE MEDIMETRIX.USUARIO (
                                    ...
                                    CONSTRAINT "CK_USUARIO_PAPEL"
                                        CHECK (PAPEL IN ('MEDICO','GESTOR','ADMIN')),
...
-- (comentário) Integração com subtipos (CTI) e auditoria:
--  - Triggers futuros irão:
--     * manter DATA_ULTIMA_EDICAO em UPDATE;
--     * garantir coerência PAPEL x existência do subtipo (MEDICO/GESTOR/ADMIN).
